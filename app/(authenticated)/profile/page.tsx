...
import { Edit, Send, Heart, MessageCircle, Share2, Users, UserPlus, Camera, Smile, Check, Eye, MoreHorizontal } from "lucide-react"
          ...
          <div className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-6 sm:text-left">
            ...
            <div className="flex flex-col items-center mb-4 sm:mb-0 sm:flex-shrink-0">
              <div className="relative group">
                ...
                {isOwnProfile && (
                  <label className="absolute bottom-0 right-0 h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-lg cursor-pointer flex items-center justify-center">
                ...
                {isOwnProfile && (
                  <Dialog open={isTagDialogOpen} onOpenChange={setIsTagDialogOpen}>
                    <DialogTrigger asChild>
                      <Button variant="outline" size="sm" className="rounded-full border-blue-200 hover:bg-blue-50 text-xs sm:text-sm px-3">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              <h3 className="font-semibold text-gray-900 text-sm sm:text-base">{user.nickname || user.username}</h3>
